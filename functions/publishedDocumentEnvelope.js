...
/**
 * Loads canonical binding from `@fabric/core` when installed; otherwise resolves a **sibling**
 * `fabric/` checkout (`../../fabric` from this file) for local monorepo dev.
 * Production / CI: depend on `@fabric/core` (see `package.json`).
 */
 ...
 * @param {object} parsed - parsed documents/{id}.json
 */
...
/** Hex string matching CreatePurchaseInvoice / ClaimPurchase `contentHash`. */
