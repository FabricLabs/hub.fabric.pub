...
/**
 * Canonical messages for network-visible identity clusters (D-013 amendment).
 * Browser-safe (no Node built-ins) so Passport / Capacitor can share the
 * same strings as LiveRelay. Pairing still uses Hub `/device-links`; these
 * messages are the gossiped artifact after both sides countersign.
 */
