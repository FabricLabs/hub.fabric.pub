...
/**
 * Vendored from `@fabric/core/types/distributedExecution` (FabricLabs/fabric).
 * Hub ships a copy so `npm install` works when the git tarball omits this file.
 * Prefer linking local fabric and deleting this file once the dependency always includes it.
 *
